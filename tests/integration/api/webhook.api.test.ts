...
describe('Webhook API Integration Tests', () => {
    ...
    beforeAll(async () => {
        ...
        // Setup mocks
        const { WorkflowIntegrationService } = require('../../../api/services/workflow-integration.service');
        const { JobQueueService } = require('../../../api/services/job-queue.service');
        const { OctokitService } = require('../../../api/services/octokit.service');
        const { LoggingService } = require('../../../api/services/logging.service');
    ...
    describe('Error Handling and Retry Mechanisms', () => {
        it('should handle GitHub API errors gracefully', async () => {
            const { GitHubAPIError } = require('../../../api/models/ai-review.errors');
        ...
        it('should handle PR analysis errors with context', async () => {
            const { PRAnalysisError } = require('../../../api/models/ai-review.errors');
            mockWorkflowService.processWebhookWorkflow.mockRejectedValue(
    ...
    describe('POST /webhooks/github/manual-analysis - Manual Analysis Trigger', () => {
        ...
        it('should validate required fields for manual analysis', async () => {
            const response = await request(app)
                .post('/webhooks/github/manual-analysis')
                .send({})
                .expect(400);
