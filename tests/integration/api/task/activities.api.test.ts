...
describe("Task Activities API Integration Tests", () => {
    ...
    describe(`GET ${ENDPOINTS.TASK.PREFIX}${ENDPOINTS.TASK.ACTIVITIES.GET_ALL} - Get Task Activities`, () => {
        let testTask: any;
        ...
        it("should get all activities for task with pagination", async () => {
            const response = await request(app)
                .get(`${ENDPOINTS.TASK.PREFIX}${ENDPOINTS.TASK.ACTIVITIES.GET_ALL
        ...
        it("should return activities with user information", async () => {
            const response = await request(app)
                .get(`${ENDPOINTS.TASK.PREFIX}${ENDPOINTS.TASK.ACTIVITIES.GET_ALL.replace(":taskId", testTask.id)}`)
                .set("x-test-user-id", "installation-user")
                .expect(STATUS_CODES.SUCCESS);
    ...
    describe(`PATCH ${ENDPOINTS.TASK.PREFIX}${ENDPOINTS.TASK.ACTIVITIES.MARK_VIEWED} - Mark Activity as Viewed`, () => {
        let testTask: any;
        ...
        it("should mark activity as viewed successfully", async () => {
            const response = await request(app)
                .patch(`${ENDPOINTS.TASK.PREFIX}${ENDPOINTS.TASK.ACTIVITIES.MARK_VIEWED
